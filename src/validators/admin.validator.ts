...
export const createAdminSchema = Joi.object<CreateAdmin>({
    ...
    role: Joi.string().valid(ROLES_OPTIONS.admin, ROLES_OPTIONS.maintainer).required(),
});
...
export const updateAdminSchema = Joi.object<UpdateAdmin>({
    ...
    role: Joi.string().valid(ROLES_OPTIONS.admin, ROLES_OPTIONS.maintainer).optional(),
});
