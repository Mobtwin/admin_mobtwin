...
import {
  appsBuildByIdSchema,
  createAppsBuildSchema,
  updateAppsBuildSchema,
} from "../validators/appsBuild.validator";
import {
  createAppBuildController,
  deleteAppBuildController,
  getAllAppBuildsController,
  getAppBuildByIdController,
  updateAppBuildController,
} from "../controllers/appsBuild.controller";
import { checkPermission } from "../middlewares/rbac.middleware";
import {
  APPS_BUILD_PERMISSIONS,
  APPS_BUILD_TABLE,
...
appsBuildRouter.post(
  "/",
  checkPermission([APPS_BUILD_PERMISSIONS.CREATE]),
  validateRequest(createAppsBuildSchema),
  createAppBuildController
);
...
appsBuildRouter.put(
  "/:id",
  checkPermission([APPS_BUILD_PERMISSIONS.UPDATE], {
    action: PERMISSIONS_ACTIONS.UPDATE,
    table: APPS_BUILD_TABLE,
  }),
  validateRequest(updateAppsBuildSchema),
  updateAppBuildController
);
...
appsBuildRouter.get(
  "/:id",
  validateRequest(appsBuildByIdSchema, "params"),
  checkPermission([APPS_BUILD_PERMISSIONS.READ], {
    table: APPS_BUILD_TABLE,
...
appsBuildRouter.put(
  "/delete/:id",
  validateRequest(appsBuildByIdSchema, "params"),
  checkPermission([APPS_BUILD_PERMISSIONS.DELETE], {
    table: APPS_BUILD_TABLE,
