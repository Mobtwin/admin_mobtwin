...
import {
  assignPermissionsByIdController,
  assignPermissionsByNameController,
  createRoleController,
  getAllRolesController,
  getRoleByIdController,
  getRoleByNameController,
  unassignPermissionsByIdController,
  unassignPermissionsByNameController,
...
roleRouter.post(
  "/",
  checkPermission([ROLE_PERMISSIONS.CREATE]),
...
roleRouter.get(
  "/id/:id",
  validateRequest(roleByIdSchema, "params"),
  checkPermission([ROLE_PERMISSIONS.READ], {
    table: ROLE_TABLE,
...
roleRouter.get(
  "/name/:name",
  validateRequest(roleByNameSchema, "params"),
  checkPermission([ROLE_PERMISSIONS.READ], {
    table: ROLE_TABLE,
    action: PERMISSIONS_ACTIONS.READ,
  }),
...
roleRouter.patch(
  "/assign/id/:id",
  validateRequest(roleByIdSchema, "params"),
  checkPermission([ROLE_PERMISSIONS.UPDATE], {
    table: ROLE_TABLE,
    action: PERMISSIONS_ACTIONS.UPDATE,
  }),
  validateRequest(togglePermissionsSchema),
  assignPermissionsByIdController
);
